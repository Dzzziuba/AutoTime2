...
<div class="brandlistspaces">
    ...
    <%
        ...
        brand.setId(brandId);
        if (brand.getId() != 0) {%>
    <h1 style="color:#5C97BF;">${param.brand_name}</h1> <%if (BooleanUtils.isTrue((Boolean) session.getAttribute("Login"))) {%>
    ...
    %>
    <p class="whitespace">
    <form method="get" action="/AddNewModel"><input type="submit" class="addbutton" value="+ Add new model"/></form>
    </p>
